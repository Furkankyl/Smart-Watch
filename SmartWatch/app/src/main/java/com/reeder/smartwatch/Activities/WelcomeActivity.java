...
import com.reeder.smartwatch.Helpers.PrefManager;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private int[] layouts;
    private Button btnSkip, btnNext, registerH, loginH;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerH = (Button) findViewById(R.id.registerH);
        loginH = (Button) findViewById(R.id.loginH);

        registerH.getBackground().setAlpha(240);  // 255 son sınır
        loginH.getBackground().setAlpha(25);  // 25% transparent
